    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Update([FromBody]CrudViewModel<UserProfile> payload)
        {
            ...
            try
            {
                ...
                var User = _context.ApplicationUser.FirstOrDefault(c=>c.Id==payload.value.ApplicationUserId);
                User.Email = profile.Email;
                User.UserName = profile.Email;
                User.EmailConfirmed = true;
                User.IsAdmin = profile.IsAdmin;
                //ApplicationUser user = new ApplicationUser() { Email = profile.Email, UserName = profile.Email, EmailConfirmed = true, IsAdmin = profile.IsAdmin, Id = profile.ApplicationUserId };
